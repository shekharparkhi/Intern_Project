    ...
    private void updateUIForPurchaseSuccess(PaymentResponse response) {
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                intent.setClass(CreditCardManualActivity.this, ThanksActivity.class);

                CreditCardManualActivity.this.startActivity(intent);
                CreditCardManualActivity.this.finish();
