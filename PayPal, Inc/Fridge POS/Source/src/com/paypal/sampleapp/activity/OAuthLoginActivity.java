...
public class OAuthLoginActivity extends MyActivity {
    ...
    private void proceedToBillingActivity() {
        Intent intent = new Intent(OAuthLoginActivity.this, WelcomeActivity.class);
    ...
    private void openAddressDialog() {
        ...
        addressDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                m.setBusinessName("Beer @ Work Day!");                                                                              // edited
                m.setFullName(getMerchantInfo().getFirstName(), getMerchantInfo().getLastName());                                   // not edited
        ...
        addressDialog.show(); // if no need of address box, comment
    }
    ...
    private void setMerchantAndCheckIn(String accessToken, String refreshUrl) {
        ...
        PayPalHereSDK.setCredentials(credentials, new DefaultResponseHandler<Merchant,
            ...
            public void onSuccess(Merchant merchant) {
                ...
                openAddressDialog(); // no need of address box

                //proceedToBillingActivity(); // proceed to welcome activity
            }
    ...
    private void checkinMerchant() {
        ...
        PayPalHereSDK.getMerchantManager().checkinMerchant("Beer @ Work Day!",
    ...
    private class LoginTask extends AsyncTask<String, Void, ArrayList<String>> {
        ...
        private synchronized void parseMerchantInfo(JSONObject merchantInfoJson) {
            ...
            try {
                ...
                mMerchantInfo = DomainFactory.newMerchant("Beer @ Work Day!", null, address,
                        merchantEmail, currency, "0016193003729");
                mMerchantInfo.setAvailabilityType(AvailabilityTypeEnum.OPEN);
                mMerchantInfo.setMobilityType(MobilityTypeEnum.FIXED); // Fixed or Mobile?

            } catch (Exception ex) { // NO JSON EXCEPTION thrown in corresponding try block; else catch (JSONException ex)
                setFailed();
